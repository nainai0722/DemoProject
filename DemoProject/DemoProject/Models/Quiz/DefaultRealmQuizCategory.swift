//
//  DefaultRealmQuizCatogory.swift
//  DemoProject
//
...
class DefaultRealmQuizCategory: Object, Identifiable {
    @Persisted(primaryKey: true) var id: Int
    @Persisted var title: String
    @Persisted var starCount: Int
    @Persisted var quizItems: RealmSwift.List<DefaultRealmQuiz>
    ...
    init(id: Int, title: String, starCount: Int, quizItems: List<DefaultRealmQuiz>, completed: Bool, correctCount: Int, createdAt: Date) {
        super.init()
        let realm = try! Realm()
    ...
    convenience init(id: Int, title: String, starCount: Int, createdAt: Date) {
        ...
        self.title = title
        self.starCount = starCount
        self.quizItems = List<DefaultRealmQuiz>() // 空のリストを作成
