...
final class QuizCategoryListModel: ObservableObject {
    ...
    func fetch() {
        ...
        let fetchedCategories: [QuizCategory] = RealmQuizRepository().fetchLocalQuiz()
...
//            print("一致したものは見つからない")
    ...
    let yomiQuiz3: [Quiz] = [
        Quiz(id: 70, title: "読み方を当てよう", detail: "『草原』", answerNumber: 0, quizOptions: ["そうげん", "くさばら", "そうはら", "くさはら"], quizType: .readQuiz),
        Quiz(id: 71, title: "読み方を当てよう", detail: "『午前』", answerNumber: 0, quizOptions: ["ごぜん", "うままえ", "ごご", "まえひる"], quizType: .readQuiz),
        Quiz(id: 72, title: "読み方を当てよう", detail: "『出発』", answerNumber: 0, quizOptions: ["しゅっぱつ", "でばつ", "しゅっぽつ", "はつで"], quizType: .readQuiz),
        Quiz(id: 73, title: "読み方を当てよう", detail: "『茶色』", answerNumber: 2, quizOptions: ["ちゃしょく", "さゆいろ", "ちゃいろ", "おういろ"], quizType: .readQuiz),
        Quiz(id: 74, title: "読み方を当てよう", detail: "『台風』", answerNumber: 1, quizOptions: ["たいふ", "たいふう", "だいかぜ", "ふうたい"], quizType: .readQuiz),
        Quiz(id: 75, title: "読み方を当てよう", detail: "『図書館』", answerNumber: 0, quizOptions: ["としょかん", "ずがくかん", "とがくかん", "しょとずかん"], quizType: .readQuiz),
        Quiz(id: 76, title: "読み方を当てよう", detail: "『遠足』", answerNumber: 2, quizOptions: ["とおあし", "えんほ", "えんそく", "あしなが"], quizType: .readQuiz),
        Quiz(id: 77, title: "読み方を当てよう", detail: "『軽食』", answerNumber: 1, quizOptions: ["けいじき", "けいしょく", "かるしょく", "しょうしょく"], quizType: .readQuiz),
        Quiz(id: 78, title: "読み方を当てよう", detail: "『体育』", answerNumber: 2, quizOptions: ["たいく", "たいい", "たいいく", "たいぎょう"], quizType: .readQuiz),
        Quiz(id: 79, title: "読み方を当てよう", detail: "『黒板』", answerNumber: 0, quizOptions: ["こくばん", "くろいた", "こくいた", "くろばん"], quizType: .readQuiz)
    ]
//id 89
    let yomiQuiz4: [Quiz] = [
        Quiz(id: 80, title: "読み方を当てよう", detail: "『温度』", answerNumber: 0, quizOptions: ["おんど", "あつさ", "ぬくもり", "どあつ"], quizType: .readQuiz),
        Quiz(id: 81, title: "読み方を当てよう", detail: "『最初』", answerNumber: 1, quizOptions: ["さいしゅう", "さいしょ", "しょさい", "はじめ"], quizType: .readQuiz),
        Quiz(id: 82, title: "読み方を当てよう", detail: "『練習』", answerNumber: 0, quizOptions: ["れんしゅう", "れんしょう", "ねんしゅう", "しゅうれん"], quizType: .readQuiz),
        Quiz(id: 83, title: "読み方を当てよう", detail: "『卒業』", answerNumber: 2, quizOptions: ["そつえい", "そつこう", "そつぎょう", "ごうそつ"], quizType: .readQuiz),
        Quiz(id: 84, title: "読み方を当てよう", detail: "『植物』", answerNumber: 2, quizOptions: ["しょくもつ", "しょくぶつ", "しょっぶつ", "はなもの"], quizType: .readQuiz),
        Quiz(id: 85, title: "読み方を当てよう", detail: "『計算』", answerNumber: 0, quizOptions: ["けいさん", "けいざん", "さんけい", "かいさん"], quizType: .readQuiz),
        Quiz(id: 86, title: "読み方を当てよう", detail: "『試合』", answerNumber: 2, quizOptions: ["しあ", "しけん", "しあい", "ためあい"], quizType: .readQuiz),
        Quiz(id: 87, title: "読み方を当てよう", detail: "『自然』", answerNumber: 1, quizOptions: ["しねん", "しぜん", "じねん", "ちぜん"], quizType: .readQuiz),
        Quiz(id: 88, title: "読み方を当てよう", detail: "『習慣』", answerNumber: 2, quizOptions: ["しゅうかん", "じゅうかん", "しゅうかい", "しゅうしょく"], quizType: .readQuiz),
        Quiz(id: 89, title: "読み方を当てよう", detail: "『研究』", answerNumber: 0, quizOptions: ["けんきゅう", "けんぎゅう", "けんきょ", "きゅうけん"], quizType: .readQuiz)
    ]

    let yomiQuiz5: [Quiz] = [
        Quiz(id: 90, title: "読み方を当てよう", detail: "『歴史』", answerNumber: 1, quizOptions: ["れきじ", "れきし", "れっき", "しれき"], quizType: .readQuiz),
        Quiz(id: 91, title: "読み方を当てよう", detail: "『政治』", answerNumber: 0, quizOptions: ["せいじ", "せいち", "じせい", "しせい"], quizType: .readQuiz),
        Quiz(id: 92, title: "読み方を当てよう", detail: "『国際』", answerNumber: 0, quizOptions: ["こくさい", "こくさいき", "こくさく", "さいこく"], quizType: .readQuiz),
        Quiz(id: 93, title: "読み方を当てよう", detail: "『産業』", answerNumber: 1, quizOptions: ["さんごう", "さんぎょう", "ぎょうさん", "ぎょうば"], quizType: .readQuiz),
        Quiz(id: 94, title: "読み方を当てよう", detail: "『文学』", answerNumber: 0, quizOptions: ["ぶんがく", "ぶんしゃ", "ぶんえい", "がくぶん"], quizType: .readQuiz),
        Quiz(id: 95, title: "読み方を当てよう", detail: "『重要』", answerNumber: 2, quizOptions: ["しゅうよう", "じゅうもう", "じゅうよう", "ようじゅう"], quizType: .readQuiz),
        Quiz(id: 96, title: "読み方を当てよう", detail: "『教育』", answerNumber: 1, quizOptions: ["きょうぎ", "きょういく", "きょうし", "きょうそく"], quizType: .readQuiz),
        Quiz(id: 97, title: "読み方を当てよう", detail: "『社会』", answerNumber: 0, quizOptions: ["しゃかい", "しゅかい", "しゃえ", "かいしゃ"], quizType: .readQuiz),
        Quiz(id: 98, title: "読み方を当てよう", detail: "『経済』", answerNumber: 2, quizOptions: ["けいざ", "けいし", "けいざい", "ざいけい"], quizType: .readQuiz),
        Quiz(id: 99, title: "読み方を当てよう", detail: "『環境』", answerNumber: 0, quizOptions: ["かんきょう", "かんけい", "かんこう", "きょうかん"], quizType: .readQuiz)
    ]
// id 69
...
// id 61
    ...
    let wordQuiz = [
        ...
        Quiz(id: 2, title: "漢字を当てよう", detail: "おそろしい生き物のことを「ようかい」と言うよ。当てはまる漢字はどれ？", answerNumber: 3, quizOptions: ["洋獣","用海","怪会","妖怪"]),
